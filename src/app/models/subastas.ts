export class Subastas {
  ...
  constructor(idSubasta: number, fechaInicio: string, fechaFin: string, estadoSubasta: string, tituloSubasta: string, horaCierreSubasta: string, descripcionSubasta: string, imgSubasta: string) {
